// Author: Neslihan Ustaoglu - n01734911
...
void* handle_client(void* arg) {
    ...
    printf("[Thread] Handling client %d...\n", client_id);

    printf("[Thread] Processing request for 5 seconds...\n");
    sleep(5);

    send(client_socket, message, (int)strlen(message), 0);

    printf("[Thread] Response sent to client %d\n", client_id);
...
int main() {
    ...
    printf("NOTE: This server is MULTITHREADED.\n\n");
